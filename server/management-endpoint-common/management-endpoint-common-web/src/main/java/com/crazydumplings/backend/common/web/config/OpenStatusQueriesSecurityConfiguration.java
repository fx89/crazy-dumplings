...
import com.crazydumplings.backend.security.web.config.AdditionalHttpSecurityConfig;

/**
 * Allows unconditioned access to URL's where unsecured access is required. Called from
 * {@link com.crazydumplings.backend.security.web.config.WebSecurityConfig the generic WebSecurityConfig}
 */
@Component
